    ...
    return (
      <Html>
        <Head>
          ...
          <link rel="icon" href="https://dogs-of-mtg.bermeo.dev/Logo.svg" />
          <link
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                name: "The Zombies of Magic The Gathering",
                url: "https://zombies-of-mtg.bermeo.dev/",
                text: "This tool was developed using the Static Site Generation (SSG) concept with Next.js in order to index all the zombie type cards of the Magic The Gathering for a private collection. The source code can be found on github and easily changed to any other parameter.",
          ...
          <link rel="canonical" href="https://zombies-of-mtg.bermeo.dev/" />
