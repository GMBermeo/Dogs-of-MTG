...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"
   xmlns:image="http://www.google.com/schemas/sitemap-image/1.1">`}
      {`<url>
      <loc>https://zombies-of-mtg.bermeo.dev</loc>
      <image:image>
      ...
      {`<url>
      <loc>https://zombies-of-mtg.bermeo.dev/all-prints</loc>
      <image:image>
      `}
      ...
      {`<url>
      <loc>https://zombies-of-mtg.bermeo.dev/en/all-prints</loc>
      <image:image>
      `}
      {allCardsCollection.map((card: TCard, index) => (
        <p key={index}>
      ...
      {allCardsCollection.map((card: TCard, index) => (
        <p key={index}>
          {`<url>
          <loc>https://zombies-of-mtg.bermeo.dev/card/${card.id}</loc>
            <image:image>
              <image:loc>${card.image_uris.art_crop}</image:loc>
              <image:loc>${card.image_uris.large}</image:loc>
              <image:loc>${card.image_uris.normal}</image:loc>
          ...
          <url>
          <loc>https://zombies-of-mtg.bermeo.dev/en/card/${card.id}</loc>
            <image:image>
              <image:loc>${card.image_uris.art_crop}</image:loc>
              <image:loc>${card.image_uris.large}</image:loc>
              <image:loc>${card.image_uris.normal}</image:loc>
